...
export const AdminForgotPasswordPage = () => {
  ...
  const handleRequestOtp = async (e) => {
    ...
    try {
      ...
      const msg = res.message || 'Verification OTP code dispatched to your admin email address.';
      ...
      const msg = err.message || 'Failed to request OTP for this admin email.';
      setError(msg);
      toast.error(msg);
    } finally {
      setLoading(false);
  ...
  const handleVerifyOtp = async (e) => {
    ...
    try {
      ...
      const msg = 'Admin OTP verified successfully! Enter your new password below.';
      setSuccessNotice(msg);
      toast.success(msg);
  ...
  const handleResetPassword = async (e) => {
    ...
    if (!newPassword) {
      ...
      toast.error('Please enter your new admin password.');
      return;
    }
    ...
    try {
      ...
      const msg = err.message || 'Failed to save new admin password. Please try again.';
      setError(msg);
      toast.error(msg);
    } finally {
      setLoading(false);
